...
?>
<?php
  $e_group = find_by_id('user_rol',(int)$_GET['id']);
  if(!$e_group){
     ...
     <?php echo display_msg($msg); ?>
      <form method="post" action="edit_group.php?id=<?php echo (int)$e_group['id'];?>" class="clearfix">
        ...
        <div class="form-group clearfix">
                <button type="submit" name="update" redirect="add_group.php" class="btn btn-info">Actualizar</button>
